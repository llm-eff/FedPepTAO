...
def get_args():
    ...
    parser.add_argument("--template_idx", default=0, type=int)
    parser.add_argument("--method_type", default='generative', type=str, choices=['discriminative', 'generative'])


    parser.add_argument("--json_fname", type=str, default="", help="json file name")
    # parser.add_argument("--prompt_layer_list", default=[12,13,14], help="a list of prompt layers")
    ...
    parser.add_argument("--personalization", default=False, action="store_true", help="是否做personalization")
    parser.add_argument("--scaff", default=False, help="是否+scaffold")
    parser.add_argument("--mom", default=False, help="是否+mom")
    parser.add_argument("--load_from_cache", default=False, help="是否读取分好的数据")
    ...
    if args.prompt_layer_list is None or (args.prompt_layer_list == "None"):
        args.prompt_layer_list = list(range(36))
    else:
